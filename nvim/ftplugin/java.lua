...
local config = {
	...
	cmd = {
		...
		-- 💀
		home .. "/.sdkman/candidates/java/23.0.2-amzn/bin/java", -- or '/path/to/java11_or_newer/bin/java'
		...
		java = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-23",
						path = "~/.sdkman/candidates/java/23.0.2-amzn",
					},
					{
						name = "JavaSE-11",
					...
					name = "JavaSE-17",
					path = "~/.sdkman/candidates/java/17.0.14-amzn",
				},
			},
		},
		maven = {
